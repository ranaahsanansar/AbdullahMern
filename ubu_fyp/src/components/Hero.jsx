    ...
    return (
       ...
       <div className="container w-full h-[570px] mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
           <div
               ...
               <p className="my-8 leading-relaxed text-xl">Our goal is to be the organization that provides the vehicle management solutions to help people, and other communities to prosper.</p>
           </div>
